...
public class StackEmu {
    ...
    public StackEmu(String program){
        ...
        for(String instr:this.program){
            if(instr.contains(":"))
                tableSymbol.put(instr.replace(":", ""),String.valueOf(i));
            i++;
        }
    ...
    void branch_if(){
        ...
        switch (opCond){
            case "==": if(opLeft == opRight)opCond = "true";else opCond = "false"; break;
            case "<": if(opLeft < opRight)opCond = "true";else opCond = "false"; break;
            case ">": if(opLeft > opRight)opCond = "true";else opCond = "false"; break;
            case "<=": if(opLeft <= opRight)opCond = "true";else opCond = "false"; break;
            case ">=": if(opLeft >= opRight)opCond = "true";else opCond = "false"; break;
